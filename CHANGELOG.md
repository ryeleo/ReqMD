...
- Changed shared interview group labels plus legacy-init interview labels, prompts, selection defaults, and option sets to load from packaged init YAML instead of hard-coded `rqmd-ai` Python dicts.
