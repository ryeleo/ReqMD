...
### SSVR-0309: Target-hit event capture with target metadata
- **Status:** 🔧 Implemented
...
### SSVR-0310: Trigger-release intent event capture
- **Status:** 🔧 Implemented
...
### SSVR-0311: Ready-spot departure transition event capture
- **Status:** 🔧 Implemented
...
### SSVR-0312: String start-position event capture
- **Status:** 🔧 Implemented
...
### SSVR-0313: Post-string observation event sampling
- **Status:** 🔧 Implemented
...
### SSVR-0314: Ready-spot aim dwell telemetry intent
- **Status:** 💡 Proposed
- **Priority:** 🟡 P2 - Medium
...
### SSVR-0315: Runtime warning/error diagnostics capture
- **Status:** 🔧 Implemented
...
### SSVR-0316: Telemetry reachability diagnostics
- **Status:** 🔧 Implemented
...
### SSVR-0317: Bullet-impact location capture
- **Status:** 💡 Proposed
- **Priority:** 🟠 P1 - High
...
### SSVR-0318: Replay splatter reconstruction from impact telemetry
- **Status:** 💡 Proposed
- **Priority:** 🟡 P2 - Medium
...
### SSVR-0319: Replay waypoint capture
- **Status:** 💡 Proposed
- **Priority:** 🟡 P2 - Medium
...
### SSVR-0321: Score ingestion is replay-parented
- **Status:** 💡 Proposed
- **Priority:** 🟠 P1 - High
...
### SSVR-0322: Telemetry score rows preserve replay lineage
- **Status:** 💡 Proposed
- **Priority:** 🟠 P1 - High
...
### SSVR-0323: Denormalized score indexes remain replay-linked
- **Status:** 💡 Proposed
- **Priority:** 🟠 P1 - High
...
### SSVR-0324: Score projection is reproducible from replay telemetry payload
- **Status:** 💡 Proposed
- **Priority:** 🟠 P1 - High
...
### SSVR-0325: Frame timing metrics
- **Status:** 💡 Proposed
- **Priority:** 🟡 P2 - Medium
- Given gameplay is active
...
### SSVR-0326: Telemetry versioning
- **Status:** 💡 Proposed
- **Priority:** 🟠 P1 - High
