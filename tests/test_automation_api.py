...
def test_RQMD_automation_001_check_only_mode_detects_needed_changes(
...
def test_RQMD_automation_002_single_set_updates_criterion(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
    ...
    text = (repo_with_domain_docs / "docs" / "requirements" / "demo.md").read_text(
        encoding="utf-8"
    )
    assert "- **Status:** ✅ Verified" in text


def test_RQMD_automation_002b_single_set_updates_r_prefixed_requirement(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
...
def test_RQMD_automation_003_repeatable_set_bulk_updates(
    repo_with_domain_docs: Path,
) -> None:
...
def test_RQMD_automation_003b_repeatable_set_rejects_removed_legacy_status(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_004_and_005_set_file_jsonl_with_alias_keys(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
...
@pytest.mark.parametrize(
    "key_name", ["requirement_id", "id", "req_id", "requirement_id", "r_id"]
)
...
def test_RQMD_automation_004b_set_file_csv_and_tsv_apply_rows(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
    ...
    text_after_csv = (
        repo_with_domain_docs / "docs" / "requirements" / "demo.md"
...
def test_RQMD_priority_009_set_file_jsonl_accepts_priority_only_rows(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
...
def test_RQMD_priority_009_set_file_jsonl_applies_status_and_priority_together(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
...
def test_RQMD_automation_004c_set_file_jsonl_invalid_row_reports_path_and_line(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_006_conflicting_mode_guardrails(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
    update_file = tmp_path / "updates.jsonl"
    update_file.write_text(
        '{"requirement_id":"AC-HELLO-001","status":"done"}\n', encoding="utf-8"
    )
...
def test_RQMD_automation_007_file_scope_disambiguation(two_file_repo: Path) -> None:
    ...
    first_text = (two_file_repo / "docs" / "requirements" / "first.md").read_text(
        encoding="utf-8"
    )
    second_text = (two_file_repo / "docs" / "requirements" / "second.md").read_text(
        encoding="utf-8"
    )
...
def test_RQMD_automation_008b_filtered_tree_output_supports_rqmd_prefix_by_default(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_008c_filtered_tree_auto_detects_prefix_from_requirements_index(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_009_no_summary_table_suppresses_table(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_008d_filtered_tree_accepts_plain_proposed_label(
    two_file_repo: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_008d_filtered_tree_accepts_status_prefix_token(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
...
def test_RQMD_automation_008d_filtered_tree_status_prefix_d_matches_deprecated(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain_dir = repo / "docs" / "requirements"
...
def test_RQMD_automation_008e_filtered_json_output_for_proposed(
    two_file_repo: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_008g_json_check_mode_reports_failure(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_008h_json_set_mode_reports_updates(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_rollup_005_text_mode_prints_global_totals(
    repo_with_domain_docs: Path,
) -> None:
    domain = repo_with_domain_docs / "docs" / "requirements"
    (domain / "extra.md").write_text(
...
def test_RQMD_rollup_005_json_mode_reports_global_totals(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_rollup_001_json_totals_match_live_file_counts(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_rollup_007_cli_rollup_map_equations_apply_in_text_mode(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_rollup_007_json_mode_includes_custom_columns_from_config(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
...
def test_RQMD_rollup_007_cli_map_takes_precedence_over_rollup_config(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
    config = tmp_path / "rollup.json"
    config.write_text(
...
def test_RQMD_automation_010_filter_status_implemented_json_entries_match_live_requirements() -> (
    None
):
...
def test_RQMD_automation_011_filter_status_json_empty_result_has_zero_total(
    two_file_repo: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
""",
    ...
    def fail_lookup(*_args, **_kwargs):
        raise AssertionError(
            "single-ID lookup path should not be used for repeated positional IDs"
        )
...
def test_RQMD_automation_013_filter_status_json_is_sorted_by_requirement_id(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_015_update_file_text_mode_reports_partial_failures(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
    update_file = tmp_path / "updates.jsonl"
    update_file.write_text(
...
def test_RQMD_automation_015_update_file_json_mode_reports_partial_failures(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
    update_file = tmp_path / "updates.jsonl"
    update_file.write_text(
...
def test_RQMD_automation_034_filter_no_flag_json_includes_unset(
    two_file_repo: Path,
) -> None:
    first = two_file_repo / "docs" / "requirements" / "first.md"
    first.write_text(
...
def test_RQMD_automation_034_no_flag_and_flagged_are_mutually_exclusive(
    two_file_repo: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_032_filter_no_link_json_includes_missing_links(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_032_has_link_and_no_link_are_mutually_exclusive(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_029_filter_sub_domain_json_includes_metadata(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
""",
    ...
    assert [item["id"] for item in payload["files"][0]["requirements"]] == [
        "AC-DEMO-001",
        "AC-DEMO-002",
    ]
    assert all(
        item["sub_domain"] == "Query API"
        for item in payload["files"][0]["requirements"]
    )
...
def test_RQMD_automation_029b_filter_sub_domain_json_empty_result_has_zero_total(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_030_json_includes_sub_domain_null_and_sub_sections(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_033_init_json_payload_includes_schema_version(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
...
def test_RQMD_automation_033_init_priorities_json_payload_includes_schema_version(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_027_filter_ids_file_json_expands_domain_and_subsection_tokens(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_027b_positional_target_tree_rejects_invalid_token(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_035_positional_status_and_priority_filters_narrow_results(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_035b_positional_filters_scope_remaining_targets(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
""",
    ...
    assert payload["total"] == 1
    assert [file_entry["path"] for file_entry in payload["files"]] == [
        "docs/requirements/core-engine.md"
    ]
    assert payload["files"][0]["requirements"][0]["id"] == "AC-CORE-001"


def test_RQMD_automation_036_positional_all_targets_all_requirements_newest_first(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_025_set_flagged_and_json_mode(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_025_set_file_accepts_flagged_rows(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
    update_file = tmp_path / "flagged-updates.jsonl"
    update_file.write_text(
        '{"id":"AC-HELLO-001","flagged":"false"}\n', encoding="utf-8"
    )
...
def test_RQMD_automation_022_filter_priority_json_returns_ambiguity_payload(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_017_json_no_interactive_never_prompts(
    ...
    def fail_confirm(*_args, **_kwargs):
        raise AssertionError(
            "click.confirm should not be called in JSON/non-interactive mode"
        )
...
def test_RQMD_automation_014_set_dry_run_does_not_write(
    repo_with_domain_docs: Path,
) -> None:
    target = repo_with_domain_docs / "docs" / "requirements" / "demo.md"
    before = target.read_text(encoding="utf-8")
...
def test_RQMD_automation_014_set_file_dry_run_does_not_write(
    repo_with_domain_docs: Path, tmp_path: Path
) -> None:
    target = repo_with_domain_docs / "docs" / "requirements" / "demo.md"
    before = target.read_text(encoding="utf-8")
    ...
    update_file = tmp_path / "updates.jsonl"
    update_file.write_text(
        '{"id":"AC-HELLO-001","status":"blocked"}\n', encoding="utf-8"
    )
...
def test_RQMD_automation_014_set_flagged_dry_run_json_reports_without_write(
    repo_with_domain_docs: Path,
) -> None:
    target = repo_with_domain_docs / "docs" / "requirements" / "demo.md"
    before = target.read_text(encoding="utf-8")
...
def test_RQMD_automation_021_ambiguous_status_prefix_error_includes_recommendation() -> (
    None
):
...
def test_RQMD_automation_021_ambiguous_priority_prefix_error_includes_recommendation(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_026_filter_json_domain_entry_includes_scope(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_automation_026_filter_json_domain_entry_includes_domain_body(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain_dir = repo / "docs" / "requirements"
...
def test_RQMD_automation_026_domain_body_is_none_when_no_preamble(
    repo_with_domain_docs: Path,
) -> None:
...
def test_RQMD_automation_026_summary_json_domain_entry_includes_scope(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
    ...
    assert domain["scope"] == "demo requirements"
    assert (
        "domain_body" in domain
    ), "Summary domain entry must include 'domain_body' field"


def test_RQMD_automation_009b_summary_table_uses_five_status_headers(
    repo_with_domain_docs: Path,
) -> None:
    runner = CliRunner()
    result = runner.invoke(
...
def test_RQMD_sorting_initial_summary_table_matches_default_app_order(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_sorting_initial_summary_table_honors_status_focus_strategy(
    tmp_path: Path,
) -> None:
    repo = tmp_path / "repo"
    domain = repo / "docs" / "requirements"
...
def test_RQMD_automation_027_deduplication_collapses_repeated_tokens(
    tmp_path: Path,
) -> None:
...
def test_RQMD_automation_028_targets_file_comment_only_lines_are_ignored(
    tmp_path: Path,
) -> None:
...
def test_RQMD_automation_028_targets_file_comma_separated_tokens(
    tmp_path: Path,
) -> None:
...
def test_RQMD_automation_019_unique_option_prefixes_are_accepted(
    tmp_path: Path,
) -> None:
...
def test_RQMD_automation_020_ambiguous_option_prefix_fails_with_candidate_list(
    tmp_path: Path,
) -> None:
